...
class Respondente(UserMixin, db.Model):
    ...
    email = db.Column(db.String(120), nullable=False, comment='Email do respondente')
    login = db.Column(db.String(120), unique=True, nullable=False, comment='Login único para autenticação')
